...
class PostTestCase(TestCase):
    ...
    def setUpTestData(cls):
        """
        Используется при тестировании с терминала. Создаёт временную пустую БД.
        При тестировании с дебагером в PyCharm не требуется.

        P.S. В дебагере и терминале разное количество контекстов (71 и 4)
        и ошибка с индексами
        """
